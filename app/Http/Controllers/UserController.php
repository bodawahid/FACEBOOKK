...
class UserController extends Controller
{
    ...
    public function getUserPosts(Request $request)
    {
        ...
        $profile_user_data = DB::select('select name , profile_picture , cover_picture , email , bio from users u join profiles p on u.id = p.user_id where u.id = ?', [$request->user_id]);
