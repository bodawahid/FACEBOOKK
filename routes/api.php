...
Route::middleware('web')->group(function () {
    ...
    // Replies
    Route::post('/comments/{commentId}/replies', [ReplyController::class, 'addReply']);
    Route::put('/comments/replies/{replyId}', [ReplyController::class, 'updateReply']);
    Route::delete('/comments/replies/{replyId}', [ReplyController::class, 'deleteReply']);
